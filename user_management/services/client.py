...
from user_management.schemas import NewClientSchema
...
class ClientService:
    ...
    def create_client(self, client: NewClientSchema):
        return self.client_repository.create(schema=client)

    def list_clients(self):
        return self.client_repository.list()

    def update_client(self, uid: UUID4, client: NewClientSchema):
